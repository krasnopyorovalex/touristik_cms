                ...
                <div class="col-10">
                    ...
                    <div class="list__items develop__steps">
                        <div class="list__items-item">
                            ...
                            <div class="text">
                                <p>Звонок или письмо в веб-студию – это первый шаг на пути развития вашего бизнеса в интернете. Наш специалист проконсультирует по интересующему вас виду сайта. Если вы еще не знаете, с чего начать, менеджер подскажет вам и даст рекомендации исходя из специфики бизнеса.</p>
                            </div>
                            <div class="decor">
                        ...
                        <div class="list__items-item">
                            ...
                            <div class="text">
                                <p>После того, как вы определитесь с видом сайта, наступает этап брифинга. Это сбор информации о вашем бизнесе. Помимо названия компании и основных услуг для нас важно: каким вы представляете будущий сайт, в каком цвете, какую информацию вам важно донести до клиента.</p>
                            </div>
                            <div class="decor">
                        ...
                        <div class="list__items-item">
                            ...
                            <div class="text">
                                <p>На основе брифа наш специалист составляет техническое задание (ТЗ). ТЗ необходимо как для дизайнера, так для программиста и копирайтера, которые будут работать с вашим сайтом. ТЗ согласовывается до начала работы, ведь именно согласно этому документу будет проверяться правильность и полнота выполненных работ.</p>
                            </div>
                            <div class="decor">
                        ...
                        <div class="list__items-item">
                            ...
                            <div class="text">
                                <p>На этом этапе создается внешний вид сайта: общий цвет, вид меню, расположение блоков на страницах, прорабатываются иконки и графические элементы, добавляются уникальные фишки. Дизайн создается на основе поведенческих факторов и предпочтений целевой аудитории вашего бизнеса.</p>
                            </div>
                            <div class="decor">
                        ...
                        <div class="list__items-item">
                            ...
                            <div class="text">
                                <p>Этап согласования макета дизайна обычно не занимает много времени. В этот промежуток вносятся корректировки в дизайн страниц, например размер и тип шрифта, иное расположение блока, добавление/удаление некоторых элементов. Согласование дизайна требует вашего максимального участия, т.к. в дальнейшем изменить дизайн будет сложно.</p>
                            </div>
                            <div class="decor">
                        ...
                        <div class="list__items-item">
                            ...
                            <div class="text">
                                <p>Макеты страниц переходят к новому специалисту- программист, именно он из картинки сделает полноценный работающий сайт. Это один из самых длинных временных промежутков и может занимать от 1 недели до 2 месяцев в зависимости от сложности реализации проекта.</p>
                            </div>
                            <div class="decor">
                        ...
                        <div class="list__items-item">
                            ...
                            <div class="text">
                                <p>Перед сдачей сайта его тестирует на правильность работы. Именно сейчас будут исправляться возможные ошибки, делаться доработки, пока все пункты ТЗ не будут выполнены. При желании заказчик также может участвовать и проверить работу. Обычно тестирование занимает до 5 дней.</p>
                            </div>
                            <div class="decor">
                        ...
                        <div class="list__items-item">
                            ...
                            <div class="text">
                                <p>После тщательной проверки правильной работоспособности ресурса мы передаем сайт заказчику и прилагаем инструкцию. В инструкции описаны все ключевые моменты по внесению изменений в текстовую часть сайта: как добавлять/менять/удалять страницы, загружать картинки/иконки, менять главное и нижнее меню.</p>
                            </div>
                            <div class="decor">
